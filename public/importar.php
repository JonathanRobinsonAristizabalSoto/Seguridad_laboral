...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['file'])) {
    ...
    // Validar que el archivo subido sea un archivo Excel
    $validMimeTypes = [
    ...
    if (!in_array($fileType, $validMimeTypes)) {
        die("El archivo subido no es un archivo Excel válido.");
    }
